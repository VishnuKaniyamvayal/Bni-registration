    ...
    <nav class="h-[90px] bg-[#CF2030] flex flex-row justify-between">
        ...
        <div>
            <ul class="flex pr-[120px] pt-4">
                ...
                <li><a class="text-white no-underline mx-2 text-[15px] hover:font-medium" href="<?php echo base_url('index.php/Verifyrequest')?>">MEMBER REQUESTS</a></li>
                ...
                <li><a class="text-white no-underline mx-2 text-[15px] hover:font-medium" href=<?php echo base_url('index.php/Addmember/index/0')?>>ADD MEMBER</a></li>
                <li><a class="text-white no-underline mx-2 text-[15px] hover:font-medium" href="<?php echo base_url('index.php/Loadmemberview')?>">VIEW MEMBERS</a></li>
